...
class RyBitmapFont extends RyFont {
	
	private var charset:RyTileset;
	private var characters:Hash<Int>;
	public var charWidth:Int;
	public var charHeight:Int;
	
	public function new(charset:RyTileset, characters:String) {
		super();
	...
	public static function fromAssets(id:String):RyBitmapFont {
		...
		return new RyBitmapFont(RyTileset.fromTileSize(RyTexture.fromAssets(imageFile), width, height), characters);
	}
	
	public function getCharacterTexture(character:String):RyTexture {
